...
public class dav_genR extends ValidaXml
{
  private String ref = "";
  private String cversion = "";
  private String citem = "";
  private Vector dav_itemR;

  public dav_genR ()
  {
    this.dav_itemR = new Vector();
  }
  ...
  public void addDav_item (dav_itemR a)
  {
    ValidaItemR(a);
    this.dav_itemR.add(a);
  ...
  {
    return dav_itemR.size();
  }

  public dav_itemR getDav_item (int i)
  {
    return (dav_itemR) dav_itemR.get(i);
  }

  public void ValidaItemR (dav_itemR a)
  {
    if (lista.size() > 0)
      return;
