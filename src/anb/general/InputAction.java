...
public class InputAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        try {
            ...
            //
            /*
            String cadena = "2015&201&17799&15100973&FISAP&20180124&CRCM0162&Repo#m&en$*45";

            String encriptar = Util.Encriptar(cadena);
            
            //encriptar = "gqHjPJRIFz2uWqkdJGdEUmuAEbWDqUSt8Dl7BAOnFyg=";
            String ress = Util.Desencriptar(encriptar);
            ...
            int idx6 = ress.indexOf("&", idx5+1);
            int idx7 = ress.indexOf("&", idx6+1);
            int conf = ress.length();
            String pass = ress.substring(idx7+1, conf);
            String[] d = ress.split("&"); 
            String gestion = d[0];
            String adu = d[1];
            String numero = d[2];
            ...
            */
            ...
            request.getSession().setAttribute("devuelveRutaMira",Util.devuelveRutaMira());
            request.getSession().setAttribute("devuelveNombreMira",Util.devuelveNombreMira());
                        
            request.getSession().setAttribute("funcionario",fun);
            request.getSession().setAttribute("user", ini.getUsuario().toUpperCase());
            request.getSession().setAttribute("aux1", ini.getUsuario().toUpperCase());
            request.getSession().setAttribute("aux2", ini.getClave());
            ...
            request.getSession().setAttribute("sgestion",String.valueOf(year));
