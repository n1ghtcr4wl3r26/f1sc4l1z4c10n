...
<div class="panel panel-default">
    ...
    <div class="modal-body form-horizontal">
        <html:form styleId="form-digitalizacion" action="consultafiltro.do">
            ...
            <div id="parametros">
                <div class="form-group">
                    <label class="col-sm-3 control-label">N&uacute;mero de Tr&aacute;mite:</label>
                    <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <html:select property="nivel" styleClass="form-control required">
                        <option value="-">Seleccione...</option>
                        <option value="1">PRIMER NIVEL</option>
                        <option value="n">TODAS LAS RELACIONES</option>                        
                    </html:select>
                </div>
            </div>
            */%>
  ...
  $(document).ready(function () {
      ...
      Anb.form.submit('#form-digitalizacion', function (form) {
          if (Anb.validate.run(form)) {
              ...
              $.post('relacionReporte.do', $(form).serialize(), function (response) {
      ...
      $('#tipodocumento').change(function () {
          if ($('#tipodocumento').val() == '960' || $('#tipodocumento').val()=='932' || $('#tipodocumento').val()=='B74') {
              $parametros.html("<div class='form-group'><label class='col-sm-3 control-label label-required'>Gestión:</label><div class='col-sm-4'><input type='text' name='duigestion' class='form-control required numeric' maxlength='4'  /></div></div>" + "<div class='form-group'><label class='col-sm-3 control-label label-required'>Aduana:</label><div class='col-sm-4'><input type='text' name='duiaduana' class='form-control required numeric' maxlength='3'  /></div></div>" + "<div class='form-group'><label class='col-sm-3 control-label label-required'>Número:</label><label class='col-sm-1 control-label'>C - </label><div class='col-sm-3'><input type='text' name='duinumero' class='form-control required numeric' maxlength='8'  /></div></div>");
          }
          else if ($('#tipodocumento').val() == '785') {
              $parametros.html("<div class='form-group'><label class='col-sm-3 control-label label-required'>Gestión:</label><div class='col-sm-4'><input type='text' name='duigestion' class='form-control required numeric' maxlength='4'  /></div></div>" + "<div class='form-group'><label class='col-sm-3 control-label label-required'>Aduana:</label><div class='col-sm-4'><input type='text' name='duiaduana' class='form-control required numeric' maxlength='3'  /></div></div>" + "<div class='form-group'><label class='col-sm-3 control-label label-required'>Número:</label><div class='col-sm-4'><input type='text' name='duinumero' class='form-control required numeric' maxlength='8'  /></div></div>");
          }
          else {
