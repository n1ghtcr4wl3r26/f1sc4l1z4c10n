...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <strong>REPORTE AMPLIACIÓN ALCANCE FISCALIZACIÓN</strong>
        </h4>
    </div>
    <div class="modal-body form-horizontal">
        <html:form styleId="form-repnotificacionidx" action="repampliacionidx.do" target="_blank">
...
<script>
    $(document).ready(function () {
        Anb.form.submit('#form-repnotificacionidx', function (form) {
