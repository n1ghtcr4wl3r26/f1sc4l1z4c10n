...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <strong>GENERACION HOJA DE TRABAJO DECLARACIONES</strong>
        </h4>
    </div>
    <% 
            ...
            <table class="table table-striped table-hover" id="main-table">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="text-center">Contravenci&oacute;n Aduanera Relacionada con la Declaraci&oacute;n UFV</th>
                        <th rowspan="2" class="text-center">Contravenci&oacute;n Aduanera Relacionada con la Orden UFV</th>
                        <th rowspan="2" class="text-center">Ilicito Determinado</th>
                        <th rowspan="2" class="text-center">Observaci&oacute;n</th>
                    </tr>
                    <tr>
