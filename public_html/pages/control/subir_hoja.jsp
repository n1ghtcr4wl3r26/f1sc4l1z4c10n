...
<div class="panel panel-default">
    <div class="panel-heading">   
        <h4 class="panel-title">
            <strong>SUBIR HOJA DE TRABAJO ${SubirHojaForm.tipoAlcance}</strong>
        </h4>
    </div>
    <div class="modal-body form-horizontal">
        <html:form styleId="form-subir" action="subir.do" enctype="multipart/form-data">
            <html:hidden property="codigo" styleId="codigo"/>
            <html:hidden property="tipoAlcance" styleId="tipoAlcance"/>
            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                    <strong>SUBIR HOJA DE TRABAJO EN EXCEL</strong>
                </h4>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">Hoja de Trabajo Excel:</label>
                <div class="col-sm-6" >
            ...
            <div class="btn-container">
                <button type="submit" id="boton" onclick="consultar()" class="btn btn-primary">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Subir&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
            </div>
        </html:form>
    </div>
</div>
