                ...
                <table class="table table-striped table-hover" id="main-table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" width="180px">FINALIZACI&Oacute;N DEL CONTROL - USUARIO QUE REALIZO LA
                                                    REMISI&Oacute;N A LA UNIDAD LEGAL</th>
                            <th class="text-center" width="180px">FINALIZACI&Oacute;N DEL CONTROL - FECHA DE FINALIZACI&Oacute;N DEL
                                                    CONTROL POSTERIOR</th>
                            <th class="text-center" width="180px">FINALIZACI&Oacute;N DEL CONTROL - USUARIO QUE REGISTRO LA
