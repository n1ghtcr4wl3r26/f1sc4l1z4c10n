...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <strong>REPORTE DE SEGUIMIENTO A LA ORDEN POR DUI</strong>
        </h4>
    </div>
    <% 
    ...
    <div class="modal-body form-horizontal">
        <html:form styleId="form-reporte_seguimiento_dui" action="reporte_seguimiento_duiidx.do">
                ...
                <table class="table table-striped table-hover" id="main-table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" width="180px">RESULTADOS DEL CONTROL - FECHA DE NOTIFICACI&Oacute;N DEL DOCUMENTO
                                                    DE CONCLUSI&Oacute;N</th>
                            ...
                            <th class="text-center" width="180px">RESULTADOS DEL CONTROL - FECHA COMUNICACI&Oacute;N INTERNA DE
                                                    REMISI&Oacute;N</th>
                            <th class="text-center" width="180px">RESULTADOS DEL CONTROL - N&Uacute;MERO DE COMUNICACI&Oacute;N
                                                    INTERNA DE REMISI&Oacute;N</th>
                            <th class="text-center" width="180px">FINALIZACI&Oacute;N DEL CONTROL - USUARIO QUE REALIZ&Oacute; LA
                                                    REMISI&Oacute;N A LA UNIDAD LEGAL</th>
                            <th class="text-center" width="180px">FINALIZACI&Oacute;N DEL CONTROL - FECHA DE FINALIZACI&Oacute;N DE ORDEN</th>
                            <th class="text-center" width="180px">FINALIZACI&Oacute;N DEL CONTROL - USUARIO QUE REGISTR&Oacute; LA
                    ...
                    <tbody>
                        <c:forEach items="${reporte_seguimiento_dui}" var="rep">
                            <tr>
...
<script>
  $(document).ready(function () {
      Anb.form.submit('#form-reporte_seguimiento_dui', function (form) {
