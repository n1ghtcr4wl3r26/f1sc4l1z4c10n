...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <strong>GENERACIÓN HOJA DE TRABAJO</strong>
        </h4>
    </div>
    <div class="modal-body form-horizontal">
        <html:form styleId="form-hojatrabajo" action="generacionhojaidx.do">
            ...
            <%/*<div class="form-group">
                <label class="col-sm-2 control-label">Separador de Decimales:</label>
                <div class="col-sm-2">
                    <html:select property="separador" styleClass="form-control">
                        <html:option value="coma">COMA (,)</html:option>
                        <html:option value="punto">PUNTO (.)</html:option>
                    </html:select>
                </div>
            </div>
            */%>
            <div class="form-group">
                <label class="col-sm-2 control-label">Tipo de Tramites:</label>
                <div class="col-sm-2">
                    <html:select property="tipoAlcance" styleClass="form-control required">
                        <html:option value="-">Seleccione...</html:option>
                        <html:option value="DECLARACIONES">DECLARACIONES</html:option>
                        <html:option value="TRAMITES">OTROS TRAMITES</html:option>
                    </html:select>
                </div>
            </div>
